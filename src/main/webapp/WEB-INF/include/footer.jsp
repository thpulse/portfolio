    ...
    <body>
        ...
        <footer>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-7 footer-copyright wow fadeIn" style="text-align:center;">
                        <p>Copyright 2017 KITRI - All rights reserved. Template by <a href="/project_final/index.do">Kitri</a>.</p>
                    </div>
                </div>
            </div>
        </footer>
